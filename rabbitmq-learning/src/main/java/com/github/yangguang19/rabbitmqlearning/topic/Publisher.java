...
public class Publisher
{
    ...
    private static final String TEST_TOPIC_ROUTING_KEY = "A.2";
    ...
    public static void main(String[] args) throws Exception
    {
        ...
        channel.basicPublish(TEST_TOPIC_EXCHANGE,TEST_TOPIC_ROUTING_KEY,null,TEST_TOPIC_MESSAGE.getBytes("UTF-8"));
