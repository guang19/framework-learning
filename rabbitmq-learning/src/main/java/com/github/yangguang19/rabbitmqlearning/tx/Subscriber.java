package com.github.yangguang19.rabbitmqlearning.tx;

import com.rabbitmq.client.Channel;
import com.rabbitmq.client.Connection;
import com.rabbitmq.client.DeliverCallback;

import static com.github.yangguang19.rabbitmqlearning.tx.Publisher.TEST_TX_QUEUE;
...
public class Subscriber
{
    public static void main(String[] args) throws Exception
    {
        ...
        {
            System.out.println("received message is : " + new String(delivery.getBody(),"UTF-8"));
        };
        try
        {
            channel.txSelect();
