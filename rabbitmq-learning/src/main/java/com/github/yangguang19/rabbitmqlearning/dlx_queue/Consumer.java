package com.github.yangguang19.rabbitmqlearning.dlx_queue;
...
import static com.github.yangguang19.rabbitmqlearning.dlx_queue.Publisher.TEST_NORMAL_EXCHANGE;
...
public class Consumer
{
    ...
    public static void main(String[] args) throws Exception
    {
        ...
        {
            System.out.println("normal queue received message is : " + new String(delivery.getBody(),"UTF-8"));
