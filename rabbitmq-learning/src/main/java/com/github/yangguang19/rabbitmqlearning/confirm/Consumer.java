package com.github.yangguang19.rabbitmqlearning.confirm;
...
import static com.github.yangguang19.rabbitmqlearning.confirm.Publisher.TEST_CONFIRM_QUEUE;
...
public class Consumer
{
    public static void main(String[] args)  throws Exception
    {
        ...
        {
            System.out.println("queue received message is : " + new String(delivery.getBody(),"UTF-8"));
